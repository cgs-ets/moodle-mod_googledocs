...
$string['dist_all_share_same'] = ' All students share same copy';
...
$string['distribution_choice'] = 'Distribution choice';
$string['distribution_choice_help'] = 'Concurrent permissions operations on the same file are not supported by Google Drive API.';
